...
{
    public class AddCoursesController : BaseController<Course, AddCourseRepository, int>
    {
        private readonly MyContext context;
        private readonly AddCourseRepository courseRepository;
        private readonly SubCourseRepository subcourseRepository;
        private readonly ReviewRepository reviewRepository;
  
        public AddCoursesController(ReviewRepository reviewRepository, AddCourseRepository repository, MyContext myContext,SubCourseRepository subCourseRepository) : base(repository)
        {
