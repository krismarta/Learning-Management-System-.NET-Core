...
{
    public class RegisterRepository : GeneralRepository<User, string>
    {
        ...
        public HttpStatusCode CheckEmail(string email)
        {
            var result = httpClient.GetAsync(request +"check/" + email).Result;
            return result.StatusCode;
        }
